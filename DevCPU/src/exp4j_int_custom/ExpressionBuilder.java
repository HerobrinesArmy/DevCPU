...
//			customFunctions.put("tanh", tanh);
	 ...
	 * @return the {@link ExpressionBuilder} instance
	 */
	public ExpressionBuilder withVariable(String variableName, int value) {
	 ...
	 * @return the {@link ExpressionBuilder} instance
	 */
	public ExpressionBuilder withVariables(Map<String, Integer> variableMap) {
		for (Entry<String, Integer> v : variableMap.entrySet()) {
