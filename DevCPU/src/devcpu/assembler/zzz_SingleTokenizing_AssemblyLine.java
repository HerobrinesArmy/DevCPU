...
//
//public class zzz_SingleTokenizing_AssemblyLine {
...
//
//	public zzz_SingleTokenizing_AssemblyLine(AssemblyDocument document, int lineNumber, String lineText) {
...
//	}
//
//	public void setTokens(LexerToken[] tokens) {
//		this.tokens = tokens;
//		if (directive != null) {
...
//					throw new BadValueException(this.document.getAssembly(), tokens, aAccessor + " used in an address or expression.");
//				}
...
//						throw new BadValueException(this.document.getAssembly(), tokens, bAccessor + " used in an address or expression.");
//					}
